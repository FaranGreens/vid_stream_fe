        ...
        <div className={styles.Footer}>
            ...
            <div className={styles.connect}>
                <div className="social-unit col-xs-4">
                    <div>
                        <p>Connect with us</p>
                        <a   className={styles.fb} href="https://www.facebook.com/DisneyPlusHotstar" target="_blank" rel="noopener noreferrer"><i className="fa-brands fa-facebook-f"></i></a>
                        <a  className={styles.twitter} href="https://twitter.com/DisneyPlusHS" target="_blank" rel="noopener noreferrer"><i className="fa-brands fa-square-twitter"></i></a>
                    </div>
                </div>
                <div className="app-unit col-xs-8">
                    <div className="store-wrapper">
                        <p>Disney+ Hotstar App</p>
                        <a className={styles.playstore} href="https://play.google.com/store/apps/details?id=in.startv.hotstar" target="_blank" rel="noopener noreferrer"><i className="fa-brands fa-google-play"></i></a>
                        <a className={styles.appstore} href="https://itunes.apple.com/in/app/hotstar/id934459219?mt=8" target="_blank" rel="noopener noreferrer"><i className="fa-brands fa-app-store"></i></a>
                    </div>
                </div>
            </div>
        </div>
